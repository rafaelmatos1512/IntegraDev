        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li><Link href="/produtos#agentes-ia" className="hover:text-blue-400 transition-colors">Agentes IA</Link></li>
              <li><Link href="/produtos#sistemas-personalizados" className="hover:text-blue-400 transition-colors">Sistemas Personalizados</Link></li>
              <li><Link href="/produtos#agentes-ia" className="hover:text-blue-400 transition-colors">Integração com WhatsApp</Link></li>
            </ul>
          </div>
        </div>
